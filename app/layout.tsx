...
export const metadata: Metadata = {
  title: "Samara Klampok - Hunian Modern di Klampok",
  description: "Temukan properti impian Anda di Samara Klampok, hunian modern dengan lokasi strategis di Klampok dengan fasilitas lengkap dan One-Gate System. Developer Kredibel, Legalitas Terjamin, Proses Mudah. Harga terjangkau.",
  icons: {
  ...
  keywords: [
    ...
    "Perumahan Klampok",
    "Rumah Klampok",
    "Hunian Modern Klampok",
    "Properti Klampok",
    "Rumah Terjangkau Klampok",
      ...
      <head>
        ...
        <noscript>
          <img height="1" width="1" style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1876550246582418&ev=PageView&noscript=1"
          />
        </noscript>
